...
class EdProgramsGridController: UICollectionViewController, UICollectionViewDelegateFlowLayout {
    //MARK : Properites
    let cellId = "Cell"
    ...
    fileprivate func setupCollectionView() {
        ...
        collectionView.register(StudyTileMediumCell.self, forCellWithReuseIdentifier: cellId)
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: cellId, for: indexPath) as! StudyTileMediumCell
        return cell
    }
